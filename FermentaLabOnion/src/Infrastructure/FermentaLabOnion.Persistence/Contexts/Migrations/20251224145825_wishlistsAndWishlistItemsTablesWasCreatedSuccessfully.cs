...
{
    public partial class wishlistsAndWishlistItemsTablesWasCreatedSuccessfully : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CookieId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_CookieId",
                table: "Wishlists",
                column: "CookieId",
                unique: true,
                filter: "[CookieId] IS NOT NULL");
        }
