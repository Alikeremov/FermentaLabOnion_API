...
{
    public class ShareSpecialTranslateRepo : TranslatedRepo<ShareSpecialTranslate>,IShareSpecialTranslateRepo
    {
        public ShareSpecialTranslateRepo(AppDbContext context) : base(context)
        {
        }
    }
}
