...
{
    public class InformationTranslateRepo : TranslatedRepo<InformationTranslate>, IInformationTranslateRepo
    {
        public InformationTranslateRepo(AppDbContext context) : base(context)
        {
        }
    }
}
