...
{
    public class CategoryTranslateRepo: TranslatedRepo<CategoryTranslate>, ICategoryTranslateRepo
    {
        public CategoryTranslateRepo(AppDbContext context) : base(context)
        {
        }
    }
}
