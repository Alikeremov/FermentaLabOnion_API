...
{
    public class ChineseWisdomTranslateRepo : TranslatedRepo<ChineseWisdomTranslate>, IChineseWisdomTranslateRepo
    {
        public ChineseWisdomTranslateRepo(AppDbContext context) : base(context)
        {
        }
    }
}
