...
{
    public class QuestionTranslateRepo : TranslatedRepo<QuestionTranslate>, IQuestionTranslateRepo
    {
        public QuestionTranslateRepo(AppDbContext context) : base(context)
        {
        }
    }
}
