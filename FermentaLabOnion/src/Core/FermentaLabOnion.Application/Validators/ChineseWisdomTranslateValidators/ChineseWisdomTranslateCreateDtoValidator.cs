...
{
    public class ChineseWisdomTranslateCreateDtoValidator : AbstractValidator<ChineseWisdomTranslateCreateDto>
    {
        public ChineseWisdomTranslateCreateDtoValidator()
        {
            RuleFor(x => x.Title)
                .NotEmpty()
                .MaximumLength(200);
